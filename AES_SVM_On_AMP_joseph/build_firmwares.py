...
def main():
    ...
    parser.add_argument("--litex_root",     default='/home/litex_root',             help="Litex installation directory;")
    ...
    with open("crt0.d", 'w', encoding='utf-8') as f:
        f.write(f"crt0.o: {args.litex_root}litex/litex/soc/cores/cpu/{configuration['name_1']}/crt0.S")
